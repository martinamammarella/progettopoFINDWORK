...
/**
 * classe da cui istanziare oggetti per il filtraggio full-time, deriva dalla classe Filters 
 * @author marty
 *
 */
public class filterFull extends Filters {
	...
	public filterFull() {};
	/**
	 * metodo per il filtraggio dei lavori in base al tipo di contratto full-time
